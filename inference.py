...
def save_mesh(models, mode,no_of_rots=1,W=None,N=None,M=None,save_path='meshes_using_hashencoder/', resolution=256):
        for j, model in enumerate(models):
            ...
            # mesh.export(save_path)
                ...
                for i in range(no_of_rots):
                    save_path2 = save_path +f'rots_idx_{i}.obj'
...
if __name__ == '__main__':
    ...
    save_mesh(models,mode,4,W,N,M,save_path=workspace1)        
